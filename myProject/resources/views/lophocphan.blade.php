...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../danhsachdoan/luanvanTS.css">
...
<body>
	<div class="top">
		<div class="top-bar">
			<a href="http://localhost/project/"><img src="../img/logo.PNG" id="logouneti"></a>
...
<div class="container">
     <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" href="#">Đề Tài Giảng Viên</a>
        </li>
        <li class="nav-item">
        ...
        <table  class="table" cellspacing="0" style="width: 100%; table-layout: fixed;">
            ...
            <thead>
                <tr>
                    ...
                    <th colspan="1" class="gwtb3-d">DN Hợp tác</th>
                    <th colspan="1" class="gwtb3-d" >Sửa</th>
                    <th colspan="1" class="gwtb3-d gwtb3-d">Xoá</th>
                </tr>
            </thead>
                    ...
                    <td align="center" style="vertical-align: top;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="left" class="JH KH" style="vertical-align: middle;"></td>
                                <td align="left" class="JH KH" style="vertical-align: middle;"></td>
                                <td align="left" class="JH KH" style="vertical-align: middle;"></td></tr>
                            </tbody>
                        </table>
                    </td>
                </tr>
...
<div class="EVB" style="display: none;">
 <div class="top-function-panel-in-data-table top-function-panel" style="">
    <div class="icon-fa-filter-top-pager" style="display: inline-block; vertical-align: middle;">
        <i class="fa fa-filter"></i>Bộ lọc</div>
...
<tr>
 ...
 <div class="poster">
		<div class="poster-content">
			...
			<li style="float:left;width: 73%;list-style: none;font-size: 16px;"><div style="font-weight: bold;">HỆ THỐNG DO TRƯỜNG ĐẠI HỌC KINH TẾ - KỸ THUẬT CÔNG NGHIỆP HÀ NỘI THIẾT KẾ & PHÁT TRIỂN.</div>
