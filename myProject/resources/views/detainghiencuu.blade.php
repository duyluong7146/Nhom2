...
<body>
 ...
 <div class="poster" style="margin-top: 80px;">
        <div class="poster-content">
            <li style="width: 10%;height: 100%;list-style: none;display: inline; float:left;margin-top: 23px;"><img src="../public/frontend/img/logo.PNG" style="width:80px;height: 100px"></li>
            <li style="float:left;width: 73%;list-style: none;font-size: 16px;margin-left: 53px;line-height: 34px;"><div style="font-weight: bold;">HỆ THỐNG DO TRƯỜNG ĐẠI HỌC KINH TẾ - KỸ THUẬT CÔNG NGHIỆP HÀ NỘI THIẾT KẾ & PHÁT TRIỂN.</div>
